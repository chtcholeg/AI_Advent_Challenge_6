...
class WeatherTool(
    ...
    override val description: String = """
        Get weather information including current conditions, forecasts, and historical data.
        You can specify location by city name or coordinates (latitude/longitude).
        Supports current weather, multi-day forecasts (up to 16 days), and historical weather data.
    """.trimIndent()
